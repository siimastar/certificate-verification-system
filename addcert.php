                ...
                <div class="row gx-4 gx-lg-5">
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <h3 class="h4 mb-2">Add</h3>
                            <p class="text-muted mb-0">Register your Certs</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <p class="text-muted mb-0">Verify your certificate.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            <div class="mb-2"><i class="bi-globe fs-1 text-primary"></i></div>
                            <h3 class="h4 mb-2">Store</h3>
                            <p class="text-muted mb-0">Store your certificates!</p>
                        </div>
                    </div>
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
                    <div class="col-lg-6">
                        ...
                        <form id="contactForm">
                            ...
                            <!-- Phone number input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" id="phone" type="tel" placeholder="2348169895827" data-sb-validations="required" />
                                <label for="phone">Password</label>
                                <div class="invalid-feedback" data-sb-feedback="phone:required">A password is required.</div>
                            </div>
                            <button class="btn btn-primary btn-xl" id="adminLogin" type="submit">Submit</button>
                        </form>
                    </div>
                </div>
                <div class="row gx-4 gx-lg-5 justify-content-center">
